...
def make_PEmodel_FemurOnly(answerModel, deformed_model, answerMarkerSet, deform_bone, which_leg, angle, angle_NS, geometryFolder):
    ...
    if not os.path.exists("C:/Users/jackr/OneDrive/Documents/GitHub/Ren_Femur_Twist_Python-copy/DEFROMED_MODEL/Geometry"):
        os.mkdir("C:/Users/jackr/OneDrive/Documents/GitHub/Ren_Femur_Twist_Python-copy/DEFROMED_MODEL/Geometry")
